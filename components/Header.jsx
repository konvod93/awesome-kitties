            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <Image className="block h-8 w-auto lg:hidden" src = "/free-icon-cat-2324803.png" width={20} height={20} alt="Your Company" />
                                <Image className="hidden h-8 w-auto lg:block" src = "/free-icon-cat-2324803.png" width={20} height={20} alt="Your Company"/>
                                ...
                                <div className="hidden sm:ml-6 sm:block">
                                    <div className="flex space-x-4">
                                        ...
                                        <Link href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</Link>
                            ...
                            <div className="relative ml-3">
                                <div>
                                    <button type="button" className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <Image className="h-8 w-8 rounded-full" src="/alfonso-castro-cGqg8Bx2Kbw-unsplash.jpg" width={20} height={20} alt="" />
                                    </button>
                                </div>
                ...
                <div className="sm:hidden" id="mobile-menu">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <Link href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">About</Link>
